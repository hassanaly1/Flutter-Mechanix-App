...
class AddV16ReportScreen extends StatefulWidget {
  final bool isUpdatingTask;
  final SideMenuController sideMenu;

  const AddV16ReportScreen(
      {super.key, required this.sideMenu, required this.isUpdatingTask});

  @override
  State<AddV16ReportScreen> createState() => _CompressorTaskScreenState();
}

class _CompressorTaskScreenState extends State<AddV16ReportScreen> {
