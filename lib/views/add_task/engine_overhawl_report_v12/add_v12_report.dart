...
class AddV12ReportScreen extends StatefulWidget {
  final bool isUpdatingTask;
  final SideMenuController sideMenu;

  const AddV12ReportScreen(
      {super.key, required this.sideMenu, required this.isUpdatingTask});

  @override
  State<AddV12ReportScreen> createState() => _CompressorTaskScreenState();
}

class _CompressorTaskScreenState extends State<AddV12ReportScreen> {
