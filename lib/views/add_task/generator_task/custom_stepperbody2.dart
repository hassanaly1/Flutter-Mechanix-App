              ...
              child: Column(
                ...
                children: [
                  const ContainerHeading(
                      heading:
                          'Cylinder Exhaust Pyrometer Temperature Readings'),
                  Row(
                    children: [
                      Flexible(
                              ...
                              child: Row(
                                children: [
                                  Radio(
                                    ...
                                    onChanged: (value) {
                                      if (value == 'NA') {
                                        controller.oilPressureDifferential
                                            .value = value!;
                                        controller
                                            .oilPressureDifferentialTextField
                                            .text = '';
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ReUsableTextField(
                            maxLines: 3,
                            hintText:
                                'Describe Excessive Vibration & Odd Noises',
                            showBackgroundShadow: controller
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ReUsableTextField(
                            ...
                            readOnly:
                                controller.problemsWithDriver.value == 'NO',
                            controller:
                                controller.problemsWithDriverDescription,
                          ),
                        ],
                      ),
                    ),
