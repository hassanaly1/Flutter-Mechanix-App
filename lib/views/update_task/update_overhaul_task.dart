...
class _UpdateOverhaulTaskScreenState extends State<UpdateOverhaulTaskScreen> {
  ...
  Future<void> createPdf(OverHaulReportModel model) async {
    try {
      ...
      addRow(grid2, 'Type', model.type);
      addRow(grid2, 'Customer', model.customerEngineInfo.customer.text);
      addRow(grid2, 'Work Order', model.customerEngineInfo.workorder.text);
      addRow(grid2, 'Location', model.customerEngineInfo.location.text);
      addRow(grid2, 'LSD', model.customerEngineInfo.lsd.text);
      addRow(grid2, 'Unit', model.customerEngineInfo.unit.text);
      addRow(grid2, 'Unit Hours', model.customerEngineInfo.unitHours.text);
      addRow(grid2, 'Engine Make', model.customerEngineInfo.engineMake.text);
      addRow(grid2, 'Engine Model', model.customerEngineInfo.engineModel.text);
      addRow(
          grid2, 'Engine Serial', model.customerEngineInfo.engineSerial.text);
      addRow(grid2, 'Engine Arrangement',
          model.customerEngineInfo.engineArrangement.text);
      addRow(grid2, 'Customer Contact',
          model.customerEngineInfo.customerContact.text);
